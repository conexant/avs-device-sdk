...
#elif ENABLE_SYNA_ESP
    // Creating Synaptics ESP connector
    std::shared_ptr<esp::ESPDataProviderInterface> espProvider = std::make_shared<esp::SynaESPDataProvider>();
    std::shared_ptr<esp::ESPDataModifierInterface> espModifier = nullptr;
#else
...
#ifdef KWD_GPIO
    m_keywordDetector = kwd::GPIOKeyWordDetector::create(
        sharedDataStream,
        compatibleAudioFormat,
        {keywordObserver},
        std::unordered_set<
