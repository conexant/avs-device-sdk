...
option(SYNA_ESP "Enable Synaptics Echo Spatial Perception (ESP)." OFF)
...
if(SYNA_ESP)
    message("Creating ${PROJECT_NAME} with Synaptics Echo Spatial Perception (ESP)")
    add_definitions(-DENABLE_SYNA_ESP)
endif()
